        ...
        json: {
            ...
            search: {
                url: (query: ISearchQuery, opts: IUrlOptions): string => {
                    return "/api/v3/json/search/images?per_page=" + opts.limit + "&page=" + query.page + "&q=" + searchToArg(query.search);
                },
            ...
            tags: {
                url: (query: ITagsQuery, opts: IUrlOptions): string => {
                    return "/api/v3/json/search/tags?per_page=" + opts.limit + "&page=" + query.page + "&q=*";
                },
